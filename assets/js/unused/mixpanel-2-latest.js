    ...
    (function() {
      ...
      c.info = {
        ...
        ba: function(a, b, d) {
          return d || c.g(a, " OPR/") ? c.g(a, "Mini") ? "Opera Mini" : "Opera" : /(BlackBerry|PlayBook|BB10)/i.test(a) ? "BlackBerry" : c.g(a, "IEMobile") || c.g(a, "WPDesktop") ? "Internet Explorer Mobile" : c.g(a, "Edge") ? "Microsoft Edge" : c.g(a, "FBIOS") ? "Facebook Mobile" : c.g(a,
            "Chrome") ? "Chrome" : c.g(a, "CriOS") ? "Chrome iOS" : c.g(a, "UCWEB") || c.g(a, "UCBrowser") ? "UC Browser" : c.g(a, "FxiOS") ? "Firefox iOS" : c.g(b || "", "Apple") ? c.g(a, "Mobile") ? "Mobile Safari" : "Safari" : c.g(a, "Android") ? "Android Mobile" : c.g(a, "Konqueror") ? "Konqueror" : c.g(a, "Firefox") ? "Firefox" : c.g(a, "MSIE") || c.g(a, "Trident/") ? "Internet Explorer" : c.g(a, "Gecko") ? "Mozilla" : ""
        },
        Eb: function(a, b, d) {
          b = {
          ...
          a = a.match(b);
          return !a ? n : parseFloat(a[a.length -
            2])
        },
        gb: function() {
        ...
        Ib: function(a) {
          return /Windows Phone/i.test(a) || /WPDesktop/.test(a) ? "Windows Phone" : /iPad/.test(a) ? "iPad" : /iPod/.test(a) ? "iPod Touch" : /iPhone/.test(a) ? "iPhone" : /(BlackBerry|PlayBook|BB10)/i.test(a) ? "BlackBerry" : /Android/.test(a) ?
            "Android" : ""
        },
        Vb: function(a) {
          a = a.split("/");
      ...
      var C = {
        ...
        Ma: function(a, b) {
          ...
          return /^cc|cardnum|ccnum|creditcard|csc|cvc|cvv|exp|pass|seccode|securitycode|securitynum|socialsec|socsec|ssn/i.test((a.name ||
            a.id || "").replace(/[^a-zA-Z0-9]/g, "")) || "string" === typeof b && (/^(?:(4[0-9]{12}(?:[0-9]{3})?)|(5[1-5][0-9]{14})|(6(?:011|5[0-9]{2})[0-9]{12})|(3[47][0-9]{13})|(3(?:0[0-5]|[68][0-9])[0-9]{11})|((?:2131|1800|35[0-9]{3})[0-9]{11}))$/.test((b || "").replace(/[\- ]/g, "")) || /(^\d{3}-?\d{2}-?\d{4}$)/.test(b)) ? r : m
        },
        rb: function(a) {
          var b;
          switch (a.tagName.toLowerCase()) {
        ...
        Mc: function(a, b) {
          ...
          if (this.Kc(d, a)) {
            for (var e = [d]; d.parentNode && !this.Oa(d,
                "body");) e.push(d.parentNode), d = d.parentNode;
            var g = [],
              j, f, i, h = r;
            c.a(e, function(a, b) {
            ...
            i && ("submit" === a.type || "click" ===
              a.type) && c.extend(e, this.wc(i));
            b.I("$web_event", e);
            return m
          }
        },
        ...
        U: function(a) {
          if (!document || !document.body) {
            ...
            var d = a.c("token");
            if (-1 <
              this.ub.indexOf(d)) console.log('autotrack already initialized for token "' + d + '"');
        ...
        ob: function(a, b) {
          ...
          try {
            ...
            e.desiredHash ? window.location.hash = e.desiredHash : window.history ? history.replaceState("", document.title, window.location.pathname +
        ...
        if (0 === j.length) k.error("The DOM query (" + a + ") returned 0 elements");
          ...
          c.o(a, this.Ub,
            function(a) {
              ...
              g.Wa(a, this, c);
              window.setTimeout(g.ac(e, j, c, m), f);
      ...
      D.prototype.Wa = function(a, b, c) {
        c.Tb = 2 === a.which ||
          a.metaKey || a.ctrlKey || "_blank" === b.target;
        c.href = b.href;
      ...
      o.prototype.Gd = function(a) {
        var b = a.upgrade,
          d;
        if (b) d = "mp_super_properties", "string" === typeof b && (d = b), b = this.v.parse(d), this.v.remove(d), this.v.remove(d, m), b && (this.props = c.extend(this.props, b.all, b.events));
      ...
      o.prototype.save = function() {
        this.disabled ||
          (this.rc(), this.v.set(this.name, c.na(this.props), this.Xa, this.Ua, this.Wb))
      };
      ...
      o.prototype.ia = function(a, b) {
        return c.j(a) ? (this.Xa = "undefined" ===
          typeof b ? this.Hb : b, c.extend(this.props, a), this.save(), m) : r
      };
      ...
      o.prototype.jb = function(a) {
        this.F({
          ...
          $initial_referring_domain: c.info.Vb(a) ||
            "$direct"
        }, "")
      };
        ...
        if (R) this.Ja.push(arguments);
          ...
          if ("img" in b) {
            ...
            j.onreadystatechange =
              function() {
                if (4 === j.readyState)
                  if (-1 !== a.indexOf("api.mixpanel.com/track") && C.Sc(j), 200 === j.status) d && (e ? d(c.ma(j.responseText)) : d(Number(j.responseText)));
                  else {
      ...
      h.prototype.I = function(a, b, d) {
        ...
        if (c.d(a)) k.error("No event name provided to mixpanel.track");
          ...
          try {
            if (this.c("autotrack") && "mp_page_view" !== a && "$create_alias" !== a) b = c.extend({},
              b, this.D), this.D = {
              $__c: 0
      ...
      h.prototype.Dd = function() {
        return this.Qa.call(this, I, arguments)
      };
      ...
      h.prototype.Za = function(a, b, c, e, g, j) {
        a !==
          this.T() && a !== this.xa("__alias") && (this.Ca("__alias"), this.Pa("distinct_id", a));
        this.lb(this.T());
        this.P.$a = m;
      ...
      h.prototype.Oc = function(a, b) {
        ...
        var d = this;
        c.d(b) && (b = this.T());
        if (a !== b) return this.Pa("__alias",
          a), this.I("$create_alias", {
          alias: a,
          distinct_id: b
        }, function() {
          d.Za(a)
      ...
      h.prototype.Xb = function(a) {
        if (c.j(a)) c.extend(this.config, a), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") || (this.config.disable_persistence = this.config.disable_cookie), this.persistence && this.persistence.dc(this.config), z = z ||
          this.c("debug")
      };
      ...
      p.prototype.tc = function(a, b, d, e, g) {
        ...
        !c.d(k) && c.j(k) && !c.V(k) &&
          (f.e.persistence.S("$add", k), this.Nb(k, function(a, d) {
            0 === a && f.e.persistence.A("$add", k);
            c.d(b) || b(a, d)
          }));
        !c.d(q) && c.j(q) && !c.V(q) && (f.e.persistence.S("$union", q), this.cc(q, function(a, b) {
      ...
      f.prototype.Va = c.l(function() {
        ...
        if (this.fc) this.Jc("bg", "visible"), this.N(a, "exiting"), setTimeout(this.xb,
          f.M);
        else {
          var b, c, e;
      ...
      f.prototype.oc = c.l(function() {
        ...
        if (!this.zd && !this.sb()[this.C]) this.zd = m, this.q.appendChild(this.ga), setTimeout(function() {
          ...
          b.preventDefault();
          a.Va()
        }), c.o(a.i("button") || a.i("mini-content"),
          "click",
          function(b) {
            b.preventDefault();
      ...
      f.prototype.Ac = function() {
        var a = [];
        this.u ? (this.L = this.L || "//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png", a.push(this.L)) : (this.ab ? (a.push(this.ab), this.Lb = '<img id="img" src="' + this.ab + '"/>') : this.Lb = "", this.L ? (a.push(this.L), this.$b = '<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="' + this.L + '" width="' + f.J + '" height="' + f.J + '"/><div id="thumbspacer"></div>') : this.$b = "");
        return a
      };
      f.prototype.Bc = function() {
        ...
        if (this.u) a = '<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>' + this.body + '</div></div></div></div></div><div id="mini-border"></div></div>';
          ...
          this.O("ie", 7) && (e = a = "");
          a = '<div id="takeover">' + this.$b + '<div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="content">' +
            this.Lb + '<div id="title">' + this.title + '</div><div id="body">' + this.body + '</div><div id="tagline"><a href="http://mixpanel.com?from=inapp" target="_blank">POWERED BY MIXPANEL</a></div></div><div id="button">' + a + '<a id="button-link" href="' + this.da + '">' + this.Uc + "</a>" + e + "</div></div></div>"
        }
